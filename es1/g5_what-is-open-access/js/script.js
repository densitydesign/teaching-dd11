...
'use strict';
    ...
    jQuery('#scroll-nav0').on("click", function() { 
		jQuery('html,body').animate({ scrollTop: jQuery("#OA").offset().top}, 1000, 'easeInOutQuart');
		return false;						   
	});
    
    

    jQuery('#scroll-nav1').on("click", function() { 
		jQuery('html,body').animate({ scrollTop: jQuery("#business").offset().top}, 1000, 'easeInOutQuart');
		return false;						   
	});
    
        jQuery('#scroll-nav2').on("click", function() { 
		jQuery('html,body').animate({ scrollTop: jQuery("#Life").offset().top}, 1000, 'easeInOutQuart');
		return false;						   
	});
    
        jQuery('#scroll-nav3').on("click", function() { 
		jQuery('html,body').animate({ scrollTop: jQuery("#Knowledge").offset().top}, 1000, 'easeInOutQuart');
		return false;						   
	});
    
        jQuery('#scroll-nav4').on("click", function() { 
		jQuery('html,body').animate({ scrollTop: jQuery("#Power").offset().top}, 1000, 'easeInOutQuart');
		return false;						   
	});
    
        jQuery('#scroll-nav5').on("click", function() { 
		jQuery('html,body').animate({ scrollTop: jQuery("#Ranker").offset().top}, 1000, 'easeInOutQuart');
		return false;						   
	});
    
        jQuery('#scroll-nav6').on("click", function() { 
		jQuery('html,body').animate({ scrollTop: jQuery("#Analysis").offset().top}, 1000, 'easeInOutQuart');
		return false;						   
	});
	
    jQuery('#scroll-nav7').on("click", function() { 
		jQuery('html,body').animate({ scrollTop: jQuery("#about").offset().top}, 1000, 'easeInOutQuart');
		return false;						   
	});
    
	/*---------------------------------------------- 
				 S C R O L L   D O W N 1
	------------------------------------------------*/
	jQuery('#scroll-down1').on("click", function() { 
		jQuery('html,body').animate({ scrollTop: jQuery("#business").offset().top}, 1000, 'easeInOutQuart');
		return false;						   
	});
        ...
        jQuery('#scroll-down3').on("click", function() { 
		jQuery('html,body').animate({ scrollTop: jQuery("#Knowledge").offset().top}, 1000, 'easeInOutQuart');
		return false;						   
	});
    
        jQuery('#scroll-down4').on("click", function() { 
		jQuery('html,body').animate({ scrollTop: jQuery("#Power").offset().top}, 1000, 'easeInOutQuart');
		return false;						   
	});
    
        jQuery('#scroll-down5').on("click", function() { 
		jQuery('html,body').animate({ scrollTop: jQuery("#Ranker").offset().top}, 1000, 'easeInOutQuart');
		return false;						   
	});
    
        jQuery('#scroll-down6').on("click", function() { 
		jQuery('html,body').animate({ scrollTop: jQuery("#Analysis").offset().top}, 1000, 'easeInOutQuart');
		return false;						   
	});
    ...
    /*---------------------------------------------- 
				 B A C K   T O P   Logo
	------------------------------------------------*/
	jQuery('#backtotoplogo').on("click", function() { 
